...
$llamar=new  mostrarRankingSemanalMangas();
$llamar->mostrar_ranking_semanal_mangas();

Class mostrarRankingSemanalMangas{
	 ...
	 ***************************************/
	public function mostrar_ranking_semanal_mangas(){
		...
		if ($con!=false){
			...
			$resultat=$select_man->obtenerRankingSemanalMangas($con);
			//$select=new BuscadorNoticia();
			//$resultat=$select->obtenerRankingSemanal($con);
