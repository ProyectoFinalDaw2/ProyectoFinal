...
if (isset($_SESSION["usuarioUploader"])){
	$uplo=$_SESSION["usuarioUploader"];
...
<html lang="en">
	<head>
		...
		<script src="../javaScripts/mostrarmangas.js"></script>
		<script src="../javaScripts/mostrarRankingMangas.js"></script>
		<!------------------------------------------------------------Coreusel------------------------------------------------->
		...
		<nav class="navbar navbar-inverse  navbar-fixed-top" role="navigation">
			...
			<div id="header">
				...
				<div id="fondosBlancos">
					...
					<small>Para poder subir mangas tienes que hacerte uploader des de el perfil de usuario</small>
					<?php }else{?>
					<a href="subirmanga.php"  class="btn btn-primary btn-lg">Subir Mangas</a></br>
					<?php } ?>
				</div>
			</div>
			</header>
		...
		<div id="sidebar">
				<section>
					...
					<article id="slidevarNoticias">
						<div id="topc">
							<h3> Ultimos Mangas<h3>
						</div>
						<div  id="fondosBlancos">
						<div  id="ultimosMangas">
						<!-- <ol >
